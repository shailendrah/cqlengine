/* $Header: cep/wlevs_cql/modules/cqlengine/test/src/oracle/cep/test/userfunctions/TkUsrPhyOp.java /main/8 2011/07/20 13:46:36 alealves Exp $ */
...
/**
 *  @version $Header: cep/wlevs_cql/modules/cqlengine/test/src/oracle/cep/test/userfunctions/TkUsrPhyOp.java /main/6 2009/08/31 10:57:18 alealves Exp $
 *  @author  najain  
...
/**
 * Test for parsing, semantic analysis, logical and physical plan generation of
 * a query
 */

public class TkUsrPhyOp
{
  ...
  public static void main(String[] args)
  {
    ...
    try {
      ...
      PhyPlanGen phyplan = new PhyPlanGen();
      // This test will not work, and has currently been hacked
      PhyOpt phyOp = phyplan.genPhysicalPlan(logOp, new PhyPlanGenContext(ec, null));
      txn.commit(ec);
      ec.setTransaction(null);

      // Examine the phyical operator tree
      StringBuilder sb2 = new StringBuilder();
      sb2.append("<Query>");
      sb2.append("<Input query=\"" + command + "\"/>");
      sb2.append("<PhyOpOutput>");
      sb2.append(phyOp.toString());
      sb2.append("</PhyOpOutput>");
      sb2.append("</Query>");
