/* $Header: cep/wlevs_cql/modules/cqlengine/test/src/oracle/cep/test/userfunctions/TkObjAggr.java /main/3 2011/10/12 07:03:25 udeshmuk Exp $ */
...
/**
 *  @version $Header: cep/wlevs_cql/modules/cqlengine/test/src/oracle/cep/test/userfunctions/TkObjAggr.java /main/2 2009/09/13 23:57:27 sbishnoi Exp $
 *  @author  anasrini
 *  @since   1.0
 */
...
public strictfp class TkObjAggr extends AggrFunctionImpl implements IAggrFnFactory, Cloneable
{
    float sum;

    public IAggrFunction newAggrFunctionHandler() throws UDAException 
    {
        return new TkObjAggr();
    }
    ...
    public void handlePlus(AggrValue[] value, 
        ...
        o.setDVal(sum/10000);
        o.setSVal("+v="+v+",oldsum="+oldsum+",sum="+sum);
