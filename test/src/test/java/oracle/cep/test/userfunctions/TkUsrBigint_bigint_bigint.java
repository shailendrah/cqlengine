/* $Header: cep/wlevs_cql/modules/cqlengine/test/src/oracle/cep/test/userfunctions/TkUsrBigint_bigint_bigint.java /main/2 2011/10/12 07:03:25 udeshmuk Exp $ */
...
/**
 *  @version $Header: TkUsrBigint_bigint_bigint.java 13-may-2008.09:01:49 hopark Exp $
 *  @author  anasrini
 *  @since   1.0
 */
...
public class TkUsrBigint_bigint_bigint extends AggrFunctionImpl implements IAggrFnFactory, Cloneable
{
  long max;
  int count;
  
  public IAggrFunction newAggrFunctionHandler() throws UDAException {
    return new TkUsrBigint_bigint_bigint();
  }
