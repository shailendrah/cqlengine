/* $Header: cep/wlevs_cql/modules/cqlengine/test/src/oracle/cep/test/userfunctions/TkUsrBigint_bigint_flt.java /main/2 2011/10/12 07:03:25 udeshmuk Exp $ */
...
/**
 *  @version $Header: TkUsrBigint_bigint_flt.java 13-may-2008.09:01:51 hopark Exp $
 *  @author  anasrini
 *  @since   1.0
 */
...
public class TkUsrBigint_bigint_flt extends AggrFunctionImpl implements IAggrFnFactory, Cloneable 
{
  float max;
  int count;
  
  public IAggrFunction newAggrFunctionHandler() throws UDAException {
    return new TkUsrBigint_bigint_flt();
  }
