/* $Header: cep/wlevs_cql/modules/cqlengine/test/src/oracle/cep/test/userfunctions/TkUsrGeometricMean.java /main/2 2011/10/12 07:03:25 udeshmuk Exp $ */
...
/**
 *  @version $Header: TkUsrGeometricMean.java 13-may-2008.09:02:23 hopark Exp $
 *  @author  sbishnoi
...
public class TkUsrGeometricMean extends AggrFunctionImpl 
  ...
  /* 
   * Function getGM() returns the geometric mean
   */
  
  private float getGM() {
    return (float)(Descriptive.geometricMean(dal));
  }
