/* $Header: cep/wlevs_cql/modules/cqlengine/server/src/oracle/cep/extensibility/functions/builtin/ToDSInterval.java /main/2 2013/10/16 07:04:05 sbishnoi Exp $ */
...
/**
 *  @version $Header: cep/wlevs_cql/modules/cqlengine/server/src/oracle/cep/extensibility/functions/builtin/ToDSInterval.java /main/2 2013/10/16 07:04:05 sbishnoi Exp $
 *  @author  sbishnoi
 *  @since   release specific (what release of product did this appear in)
 */

public class ToDSInterval implements SingleElementFunction
{
  ...
  public Object execute(Object[] args) throws UDFException
  {
    ...
    try
    {
      numNanos = IntervalConverter.parseDToSIntervalString(inputData, format);
    } 
    catch (CEPException e)
    {
