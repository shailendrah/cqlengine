/* $Header: cep/wlevs_cql/modules/cqlengine/server/src/oracle/cep/extensibility/functions/builtin/StandardDeviation.java /main/2 2013/09/27 08:50:42 pkali Exp $ */
...
/*
   ...
   MODIFIED    (MM/DD/YY)
    ...
    pkali       08/19/13 - incremental standard deviation function
    pkali       08/19/13 - Creation
 */

/**
 *  @version $Header: cep/wlevs_cql/modules/cqlengine/server/src/oracle/cep/extensibility/functions/builtin/StandardDeviation.java /main/2 2013/09/27 08:50:42 pkali Exp $
 *  @author  pkali   
...
public class StandardDeviation extends AggrFunctionImpl implements IAggrFnFactory ,
                                                    Cloneable, Serializable
{
  ...
  public Object clone()
  {
    StandardDeviation myClone = new StandardDeviation();
