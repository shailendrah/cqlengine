/* $Header: pcbpel/cep/server/src/oracle/cep/extensibility/windows/builtin/Year.java /main/3 2008/12/01 16:48:52 hopark Exp $ */
...
/*
   ...
   MODIFIED    (MM/DD/YY)
    ...
    parujain    03/23/07 - year extensible window
    parujain    03/23/07 - Creation
 */

/**
 *  @version $Header: pcbpel/cep/server/src/oracle/cep/extensibility/windows/builtin/Year.java /main/3 2008/12/01 16:48:52 hopark Exp $
 *  @author  parujain
...
public class Year implements GenericTimeWindow {
  ...
  public boolean expiredW(EventTimestamp t, EventTimestamp expTs) {
    ...
    // 0 represents the first month of the year January
