/* $Header: pcbpel/cep/server/src/oracle/cep/phyplan/codegen/StoreBinJoinFactory.java /main/3 2008/10/24 15:50:17 hopark Exp $ */
...
/**
 *  @version $Header: pcbpel/cep/server/src/oracle/cep/phyplan/codegen/StoreBinJoinFactory.java /main/3 2008/10/24 15:50:17 hopark Exp $
 *  @author  najain  
 ...
 * @author najain
 */
public class StoreBinJoinFactory extends StoreGenFactory {
  public PhyStore addStoreOpt(Object ctx) {
    ...
    if (op.getIsStream()) {
      ...
      opJoin.getJoinSyn().makeStub(store);
    }
