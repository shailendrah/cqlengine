/* $Header: pcbpel/cep/server/src/oracle/cep/phyplan/codegen/SynBinStreamJoinFactory.java /main/3 2008/10/24 15:50:14 hopark Exp $ */
...
/**
 *  @version $Header: pcbpel/cep/server/src/oracle/cep/phyplan/codegen/SynBinStreamJoinFactory.java /main/3 2008/10/24 15:50:14 hopark Exp $
 *  @author  najain  
...
/**
 * SynBinStreamJoinFactory
 *
 * @author najain
 */
public class SynBinStreamJoinFactory extends SynGenFactory {
  public void addSynOpt(Object ctx) {
    ...
    opStrJoin.setInnerSyn(inner);
    inner.setOwnOp(opStrJoin);
  }
}
