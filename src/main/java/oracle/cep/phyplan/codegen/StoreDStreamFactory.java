/* $Header: pcbpel/cep/server/src/oracle/cep/phyplan/codegen/StoreDStreamFactory.java /main/2 2008/10/24 15:50:17 hopark Exp $ */
...
/*
   ...
   MODIFIED    (MM/DD/YY)
    ...
    ayalaman    04/23/06 - physical store factory for DStream operator 
    ayalaman    04/23/06 - physical store factory for DStream operator 
    ayalaman    04/23/06 - Creation
 */

/**
 *  @version $Header: pcbpel/cep/server/src/oracle/cep/phyplan/codegen/StoreDStreamFactory.java /main/2 2008/10/24 15:50:17 hopark Exp $
 *  @author  ayalaman
...
/**
 * Store requirements for DSTREAM operator
 *
 * @since 1.0
 */

class StoreDStreamFactory extends StoreGenFactory {
