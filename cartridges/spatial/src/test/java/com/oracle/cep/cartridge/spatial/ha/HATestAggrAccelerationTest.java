 ...
 *
 */
public class HATestAggrAccelerationTest extends BaseCQLTestCase {
  public void testSpatialAggrSpeed() throws Exception {
    ...
    String[] setupDDLs = new String[] {
        ...
        "create query q1 as "
            + "IStream( "
            + "SELECT pos.id as id, aggacceleration@spatial(pos.id,pos.eventTime,pos.geom) as acceleration "
    ...
    testMetadata.addSourceMetadata("PosStream", "inpAggrAcc_PosStream");
    testMetadata.addDestinationMetadata("q1", "outAggrAcc_q1");
