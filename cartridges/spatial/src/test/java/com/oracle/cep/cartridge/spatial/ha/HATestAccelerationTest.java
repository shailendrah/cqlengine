...
/**
 * HA test to validate spatial query for Acceleration function on cqlengine in
 * HA mode.
 * 
 * @author kmulay
 *
 */
public class HATestAccelerationTest extends BaseCQLTestCase {
  public void testSpatial() throws Exception {
    ...
    String[] setupDDLs = new String[] {
        ...
        "create query q1 as "
            + "IStream( "
            + "SELECT pos.id as id, acceleration@spatial(pos.id,pos.eventTime,pos.geom) as acceleration "
    ...
    testMetadata.addSourceMetadata("PosStream", "inpAcc_PosStream");
    testMetadata.addDestinationMetadata("q1", "outAcc_q1");
